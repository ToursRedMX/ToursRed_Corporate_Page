...
interface ExoticcaQuoteFormProps {
  isOpen: boolean;
  onClose: () => void;
  lang: 'es' | 'en';
  dict: any;
...
export function ExoticcaQuoteForm({ isOpen, onClose, lang, dict }: ExoticcaQuoteFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/exoticca-quote', {
        method: 'POST',
        headers: {
      ...
      if (result.success) {
        ...
        trackTikTokEvent('Lead', { contents: [{ content_id: 'exoticca', content_type: 'product', content_name: 'Exoticca Viajes' }], currency: 'MXN', value: 0 });
        onClose();
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                required
                className="mt-2 border-slate-300 focus:border-pink-500 focus:ring-pink-500"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className="w-full mt-2 justify-start text-left font-normal border-slate-300 focus:border-pink-500 focus:ring-pink-500"
                  >
          ...
          <div>
            ...
            <Textarea
              ...
              className="mt-2 border-slate-300 focus:border-pink-500 focus:ring-pink-500 resize-none"
            />
          </div>
